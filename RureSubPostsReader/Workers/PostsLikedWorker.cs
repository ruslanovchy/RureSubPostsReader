...
public class PostsLikedWorker : BackgroundService
{
    private readonly ConsumerConfig config;
    private readonly ILogger<PostsCreateWorker> logger;
    private readonly MongoDbService mongoService;

    public PostsLikedWorker(ConsumerConfig config, ILogger<PostsCreateWorker> logger, MongoDbService postsService)
    {
        this.config = config;
        this.logger = logger;
